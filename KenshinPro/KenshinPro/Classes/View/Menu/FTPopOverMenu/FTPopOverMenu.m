...
#define FTDefaultBackgroundColor            [UIColor clearColor]//蒙版的背景色
...
-(void)setupWithMenuName:(NSString *)menuName menuImage:(id )menuImage
{
    ...
    self.menuNameLabel.textAlignment = NSTextAlignmentCenter;//configuration.textAlignment;//fxw_2017_10_11 让文本居中显示
...
-(UITableView *)menuTableView
{
    if (!_menuTableView) {
        ...
        _menuTableView.separatorColor     = [UIColor grayColor];//分割线颜色
